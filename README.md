...
<table style="width:500px;">
    ...
    <tr>
        <td>
            YES24 티켓 프로젝트에서는 팀장으로서 관리자와 고객 페이지로 나누어 서버 구현까지 하는 프로젝트를 했습니다.<br>
            Servlet과 JSP 페이지를 만들어서 이클립스에서 홈페이지 구현, DB 연동과 게시판을 만드는 방법을 익힐 수 있었습니다.<br>
            그리고 AJAX를 사용하여 실시간으로 데이터가 바뀌는 업무 또한 익힐 수 있었습니다.
        </td>
    </tr>
</table>
